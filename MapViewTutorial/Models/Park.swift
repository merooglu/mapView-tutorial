...
class Park {
    ...
    var midCoordianate = CLLocationCoordinate2D()
    ...
    init(filename: String) {
        guard let properties = Park.plist(filename) as? [String: Any], let boundaryPoints = properties["boundary"] as? [String] else { return }
        
        midCoordianate = Park.parseCoord(dict: properties, fieldName: "midCoord")
